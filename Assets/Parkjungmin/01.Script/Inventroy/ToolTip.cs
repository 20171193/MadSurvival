...
public class ToolTip : MonoBehaviour
{
    ...
    {
        SelectedSlot_Inventory.instance.slot.ClearSlot();
    }

    void IsEquipItem()
    {
        if(SelectedSlot_Inventory.instance.slot.item is Equip_Item)
        {
            Equip_Item equip_Item = (Equip_Item)SelectedSlot_Inventory.instance.slot.item;
    ...
    void IsUsedItem()
    {
        if (SelectedSlot_Inventory.instance.slot.item is Used_Item)
        {
            Used_Item used_Item = (Used_Item)SelectedSlot_Inventory.instance.slot.item;
